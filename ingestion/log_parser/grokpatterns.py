...
NGINX_ACCESS_PATTERNS = [
    "%{IPORHOST:remote_ip} - %{DATA:user_name} \[%{HTTPDATE:timestamp}\] \"%{DATA:scheme} \|\|\|\| %{DATA:http_host} \|\|\|\| %{DATA:http_accept_charset} \|\|\|\| %{DATA:http_accept_encoding} \|\|\|\| %{DATA:http_accept_language} \|\|\|\| %{DATA:http_content_length} \|\|\|\| %{DATA:http_content_md5} \|\|\|\| %{DATA:http_cookie} \|\|\|\| %{DATA:http_from} \|\|\|\| %{DATA:http_x_forwarded_for} \|\|\|\| %{DATA:http_x_forwarded_host} \|\|\|\| %{DATA:http_x_wap_profile} \|\|\|\| %{DATA:http_x_request_id} \|\|\|\| %{DATA:http_x_correlation_id} \|\|\|\| %{DATA:host} \|\|\|\| %{DATA:method} %{DATA:url} HTTP/%{DATA:http_version}\" \|\|\|\| %{DATA:response_code} \|\|\|\| %{DATA:bytes} \|\|\|\| \"%{DATA:referrer}\" \|\|\|\| \"%{DATA:agent}\" \|\|\|\| \"%{DATA:gzip_ratio}\"",
    "%{IPORHOST:remote_ip} - %{DATA:user_name} \[%{HTTPDATE:timestamp}\] \"%{DATA:scheme} \|\|\|\| %{DATA:http_host} \|\|\|\| %{DATA:http_accept_charset} \|\|\|\| %{DATA:http_accept_encoding} \|\|\|\| %{DATA:http_accept_language} \|\|\|\| %{DATA:http_content_length} \|\|\|\| %{DATA:http_content_md5} \|\|\|\| %{DATA:http_cookie} \|\|\|\| %{DATA:http_from} \|\|\|\| %{DATA:http_x_forwarded_for} \|\|\|\| %{DATA:http_x_forwarded_host} \|\|\|\| %{DATA:http_x_wap_profile} \|\|\|\| %{DATA:http_x_request_id} \|\|\|\| %{DATA:http_x_correlation_id} \|\|\|\| %{DATA:host} \|\|\|\| %{DATA:method} %{DATA:url} HTTP\" \|\|\|\| %{DATA:response_code} \|\|\|\| %{DATA:bytes} \|\|\|\| \"%{DATA:referrer}\" \|\|\|\| \"%{DATA:agent}\" \|\|\|\| \"%{DATA:gzip_ratio}\"",
    "%{IPORHOST:remote_ip} - %{DATA:user_name} \[%{HTTPDATE:timestamp}\] \"%{DATA:scheme} \|\|\|\| %{DATA:http_host} \|\|\|\| %{DATA:http_accept_charset} \|\|\|\| %{DATA:http_accept_encoding} \|\|\|\| %{DATA:http_accept_language} \|\|\|\| %{DATA:http_content_length} \|\|\|\| %{DATA:http_content_md5} \|\|\|\| %{DATA:http_cookie} \|\|\|\| %{DATA:http_from} \|\|\|\| %{DATA:http_x_forwarded_for} \|\|\|\| %{DATA:http_x_forwarded_host} \|\|\|\| %{DATA:http_x_wap_profile} \|\|\|\| %{DATA:http_x_request_id} \|\|\|\| %{DATA:http_x_correlation_id} \|\|\|\| %{DATA:host} \|\|\|\| %{DATA:request}\" \|\|\|\| %{DATA:response_code} \|\|\|\| %{DATA:bytes} \|\|\|\| \"%{DATA:referrer}\" \|\|\|\| \"%{DATA:agent}\" \|\|\|\| \"%{DATA:gzip_ratio}\"",
...
POSTFIX_MESSAGE_MATCHER = {
    ...
    'postfix/smtpd': [LineGrokker(subpattern, POSTFIX_PATTERN_REPO) for subpattern in ('%{POSTFIX_SMTP_DELIVERY}|%{POSTFIX_SMTP_CONNERR}|'+
